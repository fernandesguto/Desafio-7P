...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-[65vh] flex items-center justify-center overflow-hidden bg-gradient-to-b from-amber-50 via-white to-white text-slate-900 py-10">
      ...
      <div className="container mx-auto px-4 z-10 text-center max-w-4xl mt-8">
        <motion.div
